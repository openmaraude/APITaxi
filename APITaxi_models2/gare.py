...
class GareVoyageur(db.Model):
    ...
    longitude_entreeprincipale_wgs84 = db.Column(db.Float, doc="Longitude")
    latitude_entreeprincipale_wgs84 = db.Column(db.Float, doc="Latitude")
...
class CentreVille(db.Model):
    def __repr__(self):
        return f'<CentreVille {self.insee}: {self.population}>'

    insee = db.Column(db.String(5),  primary_key=True)
